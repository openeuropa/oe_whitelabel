...
class ContentRowTest extends ParagraphsTestBase {
  ...
  public function testWithInpageNavigationRendering(): void {
    ...
    $this->assertSame('bcl-inpage-item-1', $rich_text_title->ancestors()->eq(0)->attr('id'));
    $this->assertSame('bcl-inpage-item-6', $facts_figures->ancestors()->eq(0)->attr('id'));
    $this->assertSame('bcl-inpage-item-8', $social_media_title->ancestors()->eq(1)->attr('id'));
  }
