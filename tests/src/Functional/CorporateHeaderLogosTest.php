...
class CorporateHeaderLogosTest extends WhitelabelBrowserTestBase {
  ...
  public function testCorporateHeaderLogos(): void {
    ...
    $assert_session->elementAttributeContains('css', 'nav.w-100.shadow-sm', 'aria-label', 'Site settings navigation');
    $assert_session->elementAttributeContains('css', 'nav.w-100.shadow-sm', 'role', 'navigation');
    $assert_session->elementAttributeContains('css', 'nav.bcl-header__navbar', 'aria-label', 'Menu');
    $assert_session->elementAttributeContains('css', 'nav.bcl-header__navbar', 'role', 'navigation');
